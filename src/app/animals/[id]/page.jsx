    ...
    <div className="bg-[#F1F2ED] text-[#213D34]">
      ...
      <div className="flex flex-col md:flex-row">
        <div className="flex-1">
          <img src={`${animal.image}`} alt="" className="rounded-2xl my-4 max-w-120 mx-auto" />
        </div>
        <div className="flex-1 my-4 pl-4">
          <h1 className="bg-[#D9EF78] inline px-4 py-1 text-[#213D34] font-semibold rounded-2xl">{animal.type}</h1>
      ...
      <div className="mt-4">
          <button className="bg-[#213D34] text-white rounded-2xl py-2 w-full cursor-pointer">Book Now</button>
        </div>
